"""
Indirect Prompt Injection Agent for AegisSwarm.
"""
...
class IndirectInjectionAgent(BaseSwarmAgent):
    """
    Attacker agent specializing in indirect document, web DOM, and attachment injection payloads.
    """
    ...
    def prepare(self, record: AttackRecord, context: Optional[Dict[str, Any]] = None) -> ExecutionRequest:
        ...
        return ExecutionRequest(
            ...
            provider=provider,
            model=model,
            temperature=context.get("temperature", 0.5) if context else 0.5,
