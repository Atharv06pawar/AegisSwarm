"""
Multi-Turn Agent for AegisSwarm.
"""
...
class MultiTurnAgent(BaseSwarmAgent):
    """
    Attacker agent specializing in multi-turn conversational escalations (Crescendo, TAP, Tree of Attacks).
    """
